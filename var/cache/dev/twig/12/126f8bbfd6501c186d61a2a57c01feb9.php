...
/* pages/rythme_vital/mes_loisirs.html.twig */
class __TwigTemplate_65f1758025e6616a23c8ca6a70104612 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_5a27a8ba21ca79b61932376b2fa922d2->enter($__internal_5a27a8ba21ca79b61932376b2fa922d2_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "pages/rythme_vital/mes_loisirs.html.twig"));

        $__internal_6f47bbe9983af81f1e7450e9a3e3768f = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "pages/rythme_vital/mes_loisirs.html.twig"));

        $this->parent = $this->loadTemplate("base.html.twig", "pages/rythme_vital/mes_loisirs.html.twig", 1);
    ...
    public function block_title($context, array $blocks = [])
    {
        ...
        echo "Waou - Liste de mes loisirs
";
...
\t\t\t<a class=\"button-add\" href=\"";
        // line 12
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_rythme_vital_ajouter_mes_loisirs");
        echo "\">Ajouter</a>
\t\t\t<div class=\"container-texte-exemple\">
\t\t\t\t<h3>Dans cette rubrique indiquez le temps que vous souhaitez consacrer a vos loisirs personnels.<br>Exemple : “Aller courir 3 fois par semaines pour participer au marathon“</h3>
\t\t\t</div>
...
\t\t\t\t\t";
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["lstMesLoisirs"]) || array_key_exists("lstMesLoisirs", $context) ? $context["lstMesLoisirs"] : (function () { throw new RuntimeError('Variable "lstMesLoisirs" does not exist.', 31, $this->source); })()));
...
\t\t\t\t\t\t\t\t<a class=\"delete-button\" href=\"";
            // line 42
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_rythme_vital_mes_loisirs_delete", ["id" => twig_get_attribute($this->env, $this->source, $context["entry"], "id", [], "any", false, false, false, 42)]), "html", null, true);
            echo "\" onclick=\"return confirm('Voulez-vous vraiment supprimer ce loisir ?')\">
...
\t\t\t\t\t\t\t\t<a href=\"";
            // line 45
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_rythme_vital_modifier_mes_loisirs", ["id" => twig_get_attribute($this->env, $this->source, $context["entry"], "id", [], "any", false, false, false, 45)]), "html", null, true);
            echo "\">
...
";
    ...
    {
        return "pages/rythme_vital/mes_loisirs.html.twig";
    }
...
{% block title %}Waou - Liste de mes loisirs
{% endblock %}
{% block stylesheets %}
\t{{ parent() }}
...
\t\t<div class=\"container-list row\">
\t\t\t<a class=\"button-add\" href=\"{{ path('app_rythme_vital_ajouter_mes_loisirs') }}\">Ajouter</a>
\t\t\t<div class=\"container-texte-exemple\">
\t\t\t\t<h3>Dans cette rubrique indiquez le temps que vous souhaitez consacrer a vos loisirs personnels.<br>Exemple : “Aller courir 3 fois par semaines pour participer au marathon“</h3>
\t\t\t</div>
\t\t\t<table class=\"table table-striped\">
...
\t\t\t\t\t\t\t<td>
\t\t\t\t\t\t\t\t<a class=\"delete-button\" href=\"{{ path('app_rythme_vital_mes_loisirs_delete', {'id' : entry.id}) }}\" onclick=\"return confirm('Voulez-vous vraiment supprimer ce loisir ?')\">
\t\t\t\t\t\t\t\t\t<img style=\"width: 50%;\" src=\"{{ asset('img/icon-croix.png') }}\" alt=\"Supprimer\">
\t\t\t\t\t\t\t\t</a>
\t\t\t\t\t\t\t\t<a href=\"{{ path('app_rythme_vital_modifier_mes_loisirs', {'id' : entry.id}) }}\">
...
\t</section>
{% endblock %}
", "pages/rythme_vital/mes_loisirs.html.twig", "/Users/willyampiraud/Documents/Waou29janv/templates/pages/rythme_vital/mes_loisirs.html.twig");
    }
}
